...
//		protected const _developerKey:String = "AI39si5ojvdQW_7wzbgApyTS1EMXiEfRVZtq4usxFYDFq6ZqEDiaSsPrkNLdFPwy97z9wyGtk6FPrc35H5B9LjugSQG5duueYg";
		protected const _clientId:String = "rutegger";		
		protected const _developerKey:String = "AI39si4MhpRd1OUj3ao7HSoNv_LaCiSFguNAdtN6frlqzlu9pxCkOh3O-qx1vGmfSF_5dWJQJiwpwIbmruLwhxxxZOtfVkPuKA";
...
//				trace("exists: "+_instance._requestId);
			}				
			return _instance;
		}			
...
//			trace("^^^^^^^^^^^^^^^^^^^^");
		...
		public function getUserFavorites(username:String, categories:Array = null, keywords:Array = null, startIndex:Number = 1, maxResults:Number = 50):Number
		{
			...
			url += "?alt=json&start-index=" + startIndex + "&max-results=" + maxResults + "&key=" + _developerKey;
